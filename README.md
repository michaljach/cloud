...
1. **Clone and install dependencies:**
   ...
   > **Note**: The API build process uses `tsconfig-paths` for runtime path resolution. This allows the compiled JavaScript to resolve TypeScript path aliases at runtime.
